...
public class MundialController {
    ...
    public void inicializarJogos(MundialController controller) {
        controller.adicionarJogo(new Jogo("Quinta-Feira 11 Junho 2026", "16:00", "GMT+0", "Primeira fase", "Grupo A", getEstadioPorNome("Estádio da Cidade do México").getNome(), getEstadioPorNome("Estádio da Cidade do México").getCapacidade(), "Cidade do México", "México", "MEX", "Mexicana", "África do Sul", "RSA", "Sul-africana"));
        controller.adicionarJogo(new Jogo("Sexta-Feira 12 Junho 2026", "15:00", "GMT+0", "Primeira fase", "Grupo A", getEstadioPorNome("Estádio de Guadalajara").getNome(), getEstadioPorNome("Estádio de Guadalajara").getCapacidade(), "Guadalajara", "Coreia do Sul", "KOR", "Sul-coreana", "Chéquia", "CZE", "Checa"));
        controller.adicionarJogo(new Jogo("Sexta-Feira 12 Junho 2026", "15:00", "GMT+0", "Primeira fase", "Grupo B", getEstadioPorNome("Estádio de Toronto").getNome(), getEstadioPorNome("Estádio de Toronto").getCapacidade(), "Toronto", "Canadá", "CAN", "Canadiana", "Bósnia e Herzegovina", "BIH", "Bósnia"));
        controller.adicionarJogo(new Jogo("Sábado 13 Junho 2026", "15:00", "GMT+0", "Primeira fase", "Grupo D", getEstadioPorNome("Estádio de Los Angeles").getNome(), getEstadioPorNome("Estádio de Los Angeles").getCapacidade(), "Los Angeles", "Estados Unidos", "USA", "Americana", "Paraguai", "PAR", "Paraguai"));
        controller.adicionarJogo(new Jogo("Sábado 13 Junho 2026", "15:00", "GMT+0", "Primeira fase", "Grupo B", getEstadioPorNome("Estádio da Baía de São Francisco").getNome(), getEstadioPorNome("Estádio da Baía de São Francisco").getCapacidade(), "Área da baía de São Francisco", "Catar", "QAT", "Catarina", "Suíça", "SUI", "Suíça"));
        controller.adicionarJogo(new Jogo("Sábado 13 Junho 2026", "15:00", "GMT+0", "Primeira fase", "Grupo C", getEstadioPorNome("Estádio de Nova York/Nova Jersey").getNome(), getEstadioPorNome("Estádio de Nova York/Nova Jersey").getCapacidade(), "Nova Jersey", "Brasil", "BR", "Brasileira", "Marrocos", "MAR", "Marroquina"));
        controller.adicionarJogo(new Jogo("Domingo 14 Junho 2026", "15:00", "GMT+0", "Primeira fase", "Grupo C", getEstadioPorNome("Estádio de Boston").getNome(), getEstadioPorNome("Estádio de Boston").getCapacidade(), "Boston", "Haiti", "HAI", "Haitiana", "Escócia", "SCO", "Escocesa"));
        controller.adicionarJogo(new Jogo("Domingo 14 Junho 2026", "15:00", "GMT+0", "Primeira fase", "Grupo D", getEstadioPorNome("BC Place de Vancouver").getNome(), getEstadioPorNome("BC Place de Vancouver").getCapacidade(), "Vancouver", "Austrália", "AUS", "Australiana", "Turquia", "TUR", "Turca"));
        controller.adicionarJogo(new Jogo("Domingo 14 Junho 2026", "15:00", "GMT+0", "Primeira fase", "Grupo E", getEstadioPorNome("Estádio de Houston").getNome(), getEstadioPorNome("Estádio de Houston").getCapacidade(), "Houston", "Alemanha", "GER", "Alemã", "Curaçau", "CUW", "Curaçalense"));
        controller.adicionarJogo(new Jogo("Domingo 14 Junho 2026", "15:00", "GMT+0", "Primeira fase", "Grupo F", getEstadioPorNome("Estádio de Dallas").getNome(), getEstadioPorNome("Estádio de Dallas").getCapacidade(), "Dallas", "Holanda", "NED", "Holandesa", "Japão", "JPN", "Japonesa"));
        controller.adicionarJogo(new Jogo("Segunda-Feira 15 Junho 2026", "15:00", "GMT+0", "Primeira fase", "Grupo E", getEstadioPorNome("Estádio de Filadélfia").getNome(), getEstadioPorNome("Estádio de Filadélfia").getCapacidade(), "Filadélfia", "Costa do Marfim", "CIV", "Malandresa", "Equador", "ECU", "Equatoriana"));
        controller.adicionarJogo(new Jogo("Segunda-Feira 15 Junho 2026", "15:00", "GMT+0", "Primeira fase", "Grupo F", getEstadioPorNome("Estádio de Monterrey").getNome(), getEstadioPorNome("Estádio de Monterrey").getCapacidade(), "Monterrey", "Suécia", "SWE", "Sueca", "Tunísia", "TUN", "Tunisina"));
        controller.adicionarJogo(new Jogo("Segunda-Feira 15 Junho 2026", "15:00", "GMT+0", "Primeira fase", "Grupo H", getEstadioPorNome("Estádio de Atlanta").getNome(), getEstadioPorNome("Estádio de Atlanta").getCapacidade(), "Atlanta", "Espanha", "ESP", "Espanhola", "Cabo Verde", "CPV", "Cabo-verdiana"));
        controller.adicionarJogo(new Jogo("Segunda-Feira 15 Junho 2026", "15:00", "GMT+0", "Primeira fase", "Grupo G", getEstadioPorNome("Estádio de Seattle").getNome(), getEstadioPorNome("Estádio de Seattle").getCapacidade(), "Seattle", "Bélgica", "BEL", "Belga", "Egito", "EGY", "Egípcia"));
        controller.adicionarJogo(new Jogo("Segunda-Feira 15 Junho 2026", "15:00", "GMT+0", "Primeira fase", "Grupo H", getEstadioPorNome("Estádio de Miami").getNome(), getEstadioPorNome("Estádio de Miami").getCapacidade(), "Miami", "Arábia Saudita", "KSA", "Saudita", "Uruguai", "URU", "Uruguaia"));
        controller.adicionarJogo(new Jogo("Terça-Feira 16 Junho 2026", "15:00", "GMT+0", "Primeira fase", "Grupo G", getEstadioPorNome("Estádio de Los Angeles").getNome(), getEstadioPorNome("Estádio de Los Angeles").getCapacidade(), "Los Angeles", "RI do Irã", "IRN", "Iraniana", "Nova Zelândia", "NZL", "Neo-zelandesa"));
        controller.adicionarJogo(new Jogo("Terça-Feira 16 Junho 2026", "15:00", "GMT+0", "Primeira fase", "Grupo I", getEstadioPorNome("Estádio de Nova York/Nova Jersey").getNome(), getEstadioPorNome("Estádio de Nova York/Nova Jersey").getCapacidade(), "Nova Jersey", "França", "FRA", "Francesa", "Senegal", "SEN", "Senegalesa"));
        controller.adicionarJogo(new Jogo("Terça-Feira 16 Junho 2026", "15:00", "GMT+0", "Primeira fase", "Grupo I", getEstadioPorNome("Estádio de Boston").getNome(), getEstadioPorNome("Estádio de Boston").getCapacidade(), "Boston", "Iraque", "IRQ", "Iraquiana", "Noruega", "NOR", "Norueguesa"));
        controller.adicionarJogo(new Jogo("Quarta-Feira 17 Junho 2026", "02:00", "GMT+0", "Primeira fase", "Grupo J", getEstadioPorNome("Estádio de Kansas City").getNome(), getEstadioPorNome("Estádio de Kansas City").getCapacidade(), "Kansas City", "Argentina", "ARG", "Argentina", "Argélia", "ALG", "Argelina"));
        controller.adicionarJogo(new Jogo("Quarta-Feira 17 Junho 2026", "05:00", "GMT+0", "Primeira fase", "Grupo J", getEstadioPorNome("Estádio da Baía de São Francisco").getNome(), getEstadioPorNome("Estádio da Baía de São Francisco").getCapacidade(), "Área da baía de São Francisco", "Áustria", "AUT", "Austríaca", "Jordânia", "JOR", "Jordana"));
        controller.adicionarJogo(new Jogo("Quarta-Feira 17 Junho 2026", "18:00", "GMT+0", "Primeira fase", "Grupo K", getEstadioPorNome("Estádio de Houston").getNome(), getEstadioPorNome("Estádio de Houston").getCapacidade(), "Houston", "Portugal", "PT", "Portuguesa", "RD do Congo", "COD", "Congolesa"));
        controller.adicionarJogo(new Jogo("Quarta-Feira 17 Junho 2026", "21:00", "GMT+0", "Primeira fase", "Grupo L", getEstadioPorNome("Estádio de Dallas").getNome(), getEstadioPorNome("Estádio de Dallas").getCapacidade(), "Dallas", "Inglaterra", "ENG", "Inglesa", "Croácia", "CRO", "Croata"));
        controller.adicionarJogo(new Jogo("Quinta-Feira 18 Junho 2026", "00:00", "GMT+0", "Primeira fase", "Grupo L", getEstadioPorNome("Estádio de Toronto").getNome(), getEstadioPorNome("Estádio de Toronto").getCapacidade(), "Toronto", "Gana", "GHA", "Ganesa", "Panamá", "PAN", "Panamiana"));
        controller.adicionarJogo(new Jogo("Quinta-Feira 18 Junho 2026", "03:00", "GMT+0", "Primeira fase", "Grupo K", getEstadioPorNome("Estádio da Cidade do México").getNome(), getEstadioPorNome("Estádio da Cidade do México").getCapacidade(), "Cidade do México", "Uzbequistão", "UZB", "Usbeque", "Colômbia", "COL", "Colombiana"));
        controller.adicionarJogo(new Jogo("Quinta-Feira 18 Junho 2026", "17:00", "GMT+0", "Primeira fase", "Grupo A", getEstadioPorNome("Estádio de Atlanta").getNome(), getEstadioPorNome("Estádio de Atlanta").getCapacidade(), "Atlanta", "Chéquia", "CZE", "Checa", "África do Sul", "RSA", "Sul-africana"));
        controller.adicionarJogo(new Jogo("Quinta-Feira 18 Junho 2026", "20:00", "GMT+0", "Primeira fase", "Grupo B", getEstadioPorNome("Estádio de Los Angeles").getNome(), getEstadioPorNome("Estádio de Los Angeles").getCapacidade(), "Los Angeles", "Suíça", "SUI", "Suíça", "Bósnia e Herzegovina", "BIH", "Bósnia"));
        controller.adicionarJogo(new Jogo("Quinta-Feira 18 Junho 2026", "23:00", "GMT+0", "Primeira fase", "Grupo B", getEstadioPorNome("BC Place de Vancouver").getNome(), getEstadioPorNome("BC Place de Vancouver").getCapacidade(), "Vancouver", "Canadá", "CAN", "Canadiana", "Catar", "QAT", "Catarina"));
        controller.adicionarJogo(new Jogo("Sexta-Feira 19 Junho 2026", "02:00", "GMT+0", "Primeira fase", "Grupo A", getEstadioPorNome("Estádio de Guadalajara").getNome(), getEstadioPorNome("Estádio de Guadalajara").getCapacidade(), "Guadalajara", "México", "MEX", "Mexicana", "Coreia do Sul", "KOR", "Sul-coreana"));
        controller.adicionarJogo(new Jogo("Sexta-Feira 19 Junho 2026", "20:00", "GMT+0", "Primeira fase", "Grupo D", getEstadioPorNome("Estádio de Seattle").getNome(), getEstadioPorNome("Estádio de Seattle").getCapacidade(), "Seattle", "Estados Unidos", "USA", "Americana", "Austrália", "AUS", "Australiana"));
        controller.adicionarJogo(new Jogo("Sexta-Feira 19 Junho 2026", "23:00", "GMT+0", "Primeira fase", "Grupo C", getEstadioPorNome("Estádio de Boston").getNome(), getEstadioPorNome("Estádio de Boston").getCapacidade(), "Boston", "Escócia", "SCO", "Escocesa", "Marrocos", "MAR", "Marroquina"));
        controller.adicionarJogo(new Jogo("Sábado 20 Junho 2026", "01:30", "GMT+0", "Primeira fase", "Grupo C", getEstadioPorNome("Estádio de Filadélfia").getNome(), getEstadioPorNome("Estádio de Filadélfia").getCapacidade(), "Filadélfia", "Brasil", "BR", "Brasileira", "Haiti", "HAI", "Haitiana"));
        controller.adicionarJogo(new Jogo("Sábado 20 Junho 2026", "04:00", "GMT+0", "Primeira fase", "Grupo D", getEstadioPorNome("Estádio da Baía de São Francisco").getNome(), getEstadioPorNome("Estádio da Baía de São Francisco").getCapacidade(), "Área da baía de São Francisco", "Turquia", "TUR", "Turca", "Paraguai", "PAR", "Paraguai"));
        controller.adicionarJogo(new Jogo("Sábado 20 Junho 2026", "18:00", "GMT+0", "Primeira fase", "Grupo F", getEstadioPorNome("Estádio de Houston").getNome(), getEstadioPorNome("Estádio de Houston").getCapacidade(), "Houston", "Holanda", "NED", "Holandesa", "Suécia", "SWE", "Sueca"));
        controller.adicionarJogo(new Jogo("Sábado 20 Junho 2026", "21:00", "GMT+0", "Primeira fase", "Grupo E", getEstadioPorNome("Estádio de Toronto").getNome(), getEstadioPorNome("Estádio de Toronto").getCapacidade(), "Toronto", "Alemanha", "GER", "Alemã", "Costa do Marfim", "CIV", "Malandresa"));
        controller.adicionarJogo(new Jogo("Domingo 21 Junho 2026", "01:00", "GMT+0", "Primeira fase", "Grupo E", getEstadioPorNome("Estádio de Kansas City").getNome(), getEstadioPorNome("Estádio de Kansas City").getCapacidade(), "Kansas City", "Equador", "ECU", "Equatoriana", "Curaçau", "CUW", "Curaçalense"));
        controller.adicionarJogo(new Jogo("Domingo 21 Junho 2026", "05:00", "GMT+0", "Primeira fase", "Grupo F", getEstadioPorNome("Estádio de Monterrey").getNome(), getEstadioPorNome("Estádio de Monterrey").getCapacidade(), "Monterrey", "Tunísia", "TUN", "Tunisina", "Japão", "JPN", "Japonesa"));
        controller.adicionarJogo(new Jogo("Domingo 21 Junho 2026", "17:00", "GMT+0", "Primeira fase", "Grupo H", getEstadioPorNome("Estádio de Atlanta").getNome(), getEstadioPorNome("Estádio de Atlanta").getCapacidade(), "Atlanta", "Espanha", "ESP", "Espanhola", "Arábia Saudita", "KSA", "Saudita"));
        controller.adicionarJogo(new Jogo("Domingo 21 Junho 2026", "20:00", "GMT+0", "Primeira fase", "Grupo G", getEstadioPorNome("Estádio de Los Angeles").getNome(), getEstadioPorNome("Estádio de Los Angeles").getCapacidade(), "Los Angeles", "Bélgica", "BEL", "Belga", "Egito", "EGY", "Egípcia"));
        controller.adicionarJogo(new Jogo("Domingo 21 Junho 2026", "23:00", "GMT+0", "Primeira fase", "Grupo H", getEstadioPorNome("Estádio de Miami").getNome(), getEstadioPorNome("Estádio de Miami").getCapacidade(), "Miami", "Uruguai", "URU", "Uruguaia", "Cabo Verde", "CPV", "Cabo-verdiana"));
        controller.adicionarJogo(new Jogo("Segunda-Feira 22 Junho 2026", "02:00", "GMT+0", "Primeira fase", "Grupo G", getEstadioPorNome("BC Place de Vancouver").getNome(), getEstadioPorNome("BC Place de Vancouver").getCapacidade(), "Vancouver", "Nova Zelândia", "NZL", "Neo-zelandesa", "Egito", "EGY", "Egípcia"));
        controller.adicionarJogo(new Jogo("Segunda-Feira 22 Junho 2026", "18:00", "GMT+0", "Primeira fase", "Grupo J", getEstadioPorNome("Estádio de Dallas").getNome(), getEstadioPorNome("Estádio de Dallas").getCapacidade(), "Dallas", "Argentina", "ARG", "Argentina", "Áustria", "AUT", "Austríaca"));
        controller.adicionarJogo(new Jogo("Segunda-Feira 22 Junho 2026", "22:00", "GMT+0", "Primeira fase", "Grupo I", getEstadioPorNome("Estádio de Filadélfia").getNome(), getEstadioPorNome("Estádio de Filadélfia").getCapacidade(), "Filadélfia", "França", "FRA", "Francesa", "Iraque", "IRQ", "Iraquiana"));
        controller.adicionarJogo(new Jogo("Terça-Feira 23 Junho 2026", "01:00", "GMT+0", "Primeira fase", "Grupo I", getEstadioPorNome("Estádio de Nova York/Nova Jersey").getNome(), getEstadioPorNome("Estádio de Nova York/Nova Jersey").getCapacidade(), "Nova Jersey", "Noruega", "NOR", "Norueguesa", "Senegal", "SEN", "Senegalesa"));
        controller.adicionarJogo(new Jogo("Terça-Feira 23 Junho 2026", "04:00", "GMT+0", "Primeira fase", "Grupo J", getEstadioPorNome("Estádio da Baía de São Francisco").getNome(), getEstadioPorNome("Estádio da Baía de São Francisco").getCapacidade(), "Área da baía de São Francisco", "Jordânia", "JOR", "Jordana", "Argélia", "ALG", "Argelina"));
        controller.adicionarJogo(new Jogo("Terça-Feira 23 Junho 2026", "18:00", "GMT+0", "Primeira fase", "Grupo K", getEstadioPorNome("Estádio de Houston").getNome(), getEstadioPorNome("Estádio de Houston").getCapacidade(), "Houston", "Portugal", "PT", "Portuguesa", "Uzbequistão", "UZB", "Usbeque"));
        controller.adicionarJogo(new Jogo("Terça-Feira 23 Junho 2026", "21:00", "GMT+0", "Primeira fase", "Grupo L", getEstadioPorNome("Estádio de Boston").getNome(), getEstadioPorNome("Estádio de Boston").getCapacidade(), "Boston", "Inglaterra", "ENG", "Inglesa", "Gana", "GHA", "Ganesa"));
        controller.adicionarJogo(new Jogo("Quarta-Feira 24 Junho 2026", "00:00", "GMT+0", "Primeira fase", "Grupo L", getEstadioPorNome("Estádio de Toronto").getNome(), getEstadioPorNome("Estádio de Toronto").getCapacidade(), "Toronto", "Panamá", "PAN", "Panamiana", "Croácia", "CRO", "Croata"));
        controller.adicionarJogo(new Jogo("Quarta-Feira 24 Junho 2026", "03:00", "GMT+0", "Primeira fase", "Grupo K", getEstadioPorNome("Estádio de Guadalajara").getNome(), getEstadioPorNome("Estádio de Guadalajara").getCapacidade(), "Guadalajara", "Colômbia", "COL", "Colombiana", "RD do Congo", "COD", "Congolesa"));
        controller.adicionarJogo(new Jogo("Quarta-Feira 24 Junho 2026", "20:00", "GMT+0", "Primeira fase", "Grupo B", getEstadioPorNome("BC Place de Vancouver").getNome(), getEstadioPorNome("BC Place de Vancouver").getCapacidade(), "Vancouver", "Suíça", "SUI", "Suíça", "Canadá", "CAN", "Canadiana"));
        controller.adicionarJogo(new Jogo("Quarta-Feira 24 Junho 2026", "20:00", "GMT+0", "Primeira fase", "Grupo B", getEstadioPorNome("Estádio de Seattle").getNome(), getEstadioPorNome("Estádio de Seattle").getCapacidade(), "Seattle", "Bósnia e Herzegovina", "BIH", "Bósnia", "Catar", "QAT", "Catarina"));
        controller.adicionarJogo(new Jogo("Quarta-Feira 24 Junho 2026", "23:00", "GMT+0", "Primeira fase", "Grupo C", getEstadioPorNome("Estádio de Miami").getNome(), getEstadioPorNome("Estádio de Miami").getCapacidade(), "Miami", "Escócia", "SCO", "Escocesa", "Brasil", "BR", "Brasileira"));
        controller.adicionarJogo(new Jogo("Quarta-Feira 24 Junho 2026", "23:00", "GMT+0", "Primeira fase", "Grupo C", getEstadioPorNome("Estádio de Atlanta").getNome(), getEstadioPorNome("Estádio de Atlanta").getCapacidade(), "Atlanta", "Marrocos", "MAR", "Marroquina", "Haiti", "HAI", "Haitiana"));
        controller.adicionarJogo(new Jogo("Quinta-Feira 25 Junho 2026", "02:00", "GMT+0", "Primeira fase", "Grupo A", getEstadioPorNome("Estádio da Cidade do México").getNome(), getEstadioPorNome("Estádio da Cidade do México").getCapacidade(), "Cidade do México", "Chéquia", "CZE", "Checa", "México", "MEX", "Mexicana"));
        controller.adicionarJogo(new Jogo("Quinta-Feira 25 Junho 2026", "02:00", "GMT+0", "Primeira fase", "Grupo A", getEstadioPorNome("Estádio de Monterrey").getNome(), getEstadioPorNome("Estádio de Monterrey").getCapacidade(), "Monterrey", "África do Sul", "RSA", "Sul-africana", "Coreia do Sul", "KOR", "Sul-coreana"));
        controller.adicionarJogo(new Jogo("Quinta-Feira 25 Junho 2026", "21:00", "GMT+0", "Primeira fase", "Grupo E", getEstadioPorNome("Estádio de Filadélfia").getNome(), getEstadioPorNome("Estádio de Filadélfia").getCapacidade(), "Filadélfia", "Curaçau", "CUW", "Curaçalense", "Costa do Marfim", "CIV", "Malandresa"));
        controller.adicionarJogo(new Jogo("Quinta-Feira 25 Junho 2026", "21:00", "GMT+0", "Primeira fase", "Grupo E", getEstadioPorNome("Estádio de Nova York/Nova Jersey").getNome(), getEstadioPorNome("Estádio de Nova York/Nova Jersey").getCapacidade(), "Nova Jersey", "Equador", "ECU", "Equatoriana", "Alemanha", "GER", "Alemã"));
        controller.adicionarJogo(new Jogo("Sexta-Feira 26 Junho 2026", "00:00", "GMT+0", "Primeira fase", "Grupo F", getEstadioPorNome("Estádio de Dallas").getNome(), getEstadioPorNome("Estádio de Dallas").getCapacidade(), "Dallas", "Japão", "JPN", "Japonesa", "Suécia", "SWE", "Sueca"));
        controller.adicionarJogo(new Jogo("Sexta-Feira 26 Junho 2026", "00:00", "GMT+0", "Primeira fase", "Grupo F", getEstadioPorNome("Estádio de Kansas City").getNome(), getEstadioPorNome("Estádio de Kansas City").getCapacidade(), "Kansas City", "Tunísia", "TUN", "Tunisina", "Holanda", "NED", "Holandesa"));
        controller.adicionarJogo(new Jogo("Sexta-Feira 26 Junho 2026", "03:00", "GMT+0", "Primeira fase", "Grupo D", getEstadioPorNome("Estádio de Los Angeles").getNome(), getEstadioPorNome("Estádio de Los Angeles").getCapacidade(), "Los Angeles", "Turquia", "TUR", "Turca", "Estados Unidos", "USA", "Americana"));
        controller.adicionarJogo(new Jogo("Sexta-Feira 26 Junho 2026", "03:00", "GMT+0", "Primeira fase", "Grupo D", getEstadioPorNome("Estádio da Baía de São Francisco").getNome(), getEstadioPorNome("Estádio da Baía de São Francisco").getCapacidade(), "Área da baía de São Francisco", "Paraguai", "PAR", "Paraguai", "Austrália", "AUS", "Australiana"));
        controller.adicionarJogo(new Jogo("Sexta-Feira 26 Junho 2026", "20:00", "GMT+0", "Primeira fase", "Grupo I", getEstadioPorNome("Estádio de Boston").getNome(), getEstadioPorNome("Estádio de Boston").getCapacidade(), "Boston", "Noruega", "NOR", "Norueguesa", "França", "FRA", "Francesa"));
        controller.adicionarJogo(new Jogo("Sexta-Feira 26 Junho 2026", "20:00", "GMT+0", "Primeira fase", "Grupo I", getEstadioPorNome("Estádio de Toronto").getNome(), getEstadioPorNome("Estádio de Toronto").getCapacidade(), "Toronto", "Senegal", "SEN", "Senegalesa", "Iraque", "IRQ", "Iraquiana"));
        controller.adicionarJogo(new Jogo("Sábado 27 Junho 2026", "01:00", "GMT+0", "Primeira fase", "Grupo H", getEstadioPorNome("Estádio de Houston").getNome(), getEstadioPorNome("Estádio de Houston").getCapacidade(), "Houston", "Cabo Verde", "CPV", "Cabo-verdiana", "Arábia Saudita", "KSA", "Saudita"));
        controller.adicionarJogo(new Jogo("Sábado 27 Junho 2026", "01:00", "GMT+0", "Primeira fase", "Grupo H", getEstadioPorNome("Estádio de Guadalajara").getNome(), getEstadioPorNome("Estádio de Guadalajara").getCapacidade(), "Guadalajara", "Uruguai", "URU", "Uruguaia", "Espanha", "ESP", "Espanhola"));
        controller.adicionarJogo(new Jogo("Sábado 27 Junho 2026", "04:00", "GMT+0", "Primeira fase", "Grupo G", getEstadioPorNome("Estádio de Seattle").getNome(), getEstadioPorNome("Estádio de Seattle").getCapacidade(), "Seattle", "Egito", "EGY", "Egípcia", "Irão", "IRN", "Iraniana"));
        controller.adicionarJogo(new Jogo("Sábado 27 Junho 2026", "04:00", "GMT+0", "Primeira fase", "Grupo G", getEstadioPorNome("BC Place de Vancouver").getNome(), getEstadioPorNome("BC Place de Vancouver").getCapacidade(), "Vancouver", "Nova Zelândia", "NZL", "Neo-zelandesa", "Bélgica", "BEL", "Belga"));
        controller.adicionarJogo(new Jogo("Sábado 27 Junho 2026", "22:00", "GMT+0", "Primeira fase", "Grupo L", getEstadioPorNome("Estádio de Nova York/Nova Jersey").getNome(), getEstadioPorNome("Estádio de Nova York/Nova Jersey").getCapacidade(), "Nova Jersey", "Panamá", "PAN", "Panamiana", "Inglaterra", "ENG", "Inglesa"));
        controller.adicionarJogo(new Jogo("Sábado 27 Junho 2026", "22:00", "GMT+0", "Primeira fase", "Grupo L", getEstadioPorNome("Estádio de Filadélfia").getNome(), getEstadioPorNome("Estádio de Filadélfia").getCapacidade(), "Filadélfia", "Croácia", "CRO", "Croata", "Gana", "GHA", "Ganesa"));
        controller.adicionarJogo(new Jogo("Domingo 28 Junho 2026", "00:30", "GMT+0", "Primeira fase", "Grupo K", getEstadioPorNome("Estádio de Miami").getNome(), getEstadioPorNome("Estádio de Miami").getCapacidade(), "Miami", "Colômbia", "COL", "Colombiana", "Portugal", "PT", "Portuguesa"));
        controller.adicionarJogo(new Jogo("Domingo 28 Junho 2026", "00:30", "GMT+0", "Primeira fase", "Grupo K", getEstadioPorNome("Estádio de Atlanta").getNome(), getEstadioPorNome("Estádio de Atlanta").getCapacidade(), "Atlanta", "RD Congo", "COD", "Congolesa", "Uzbequistão", "UZB", "Usbeque"));
        controller.adicionarJogo(new Jogo("Domingo 28 Junho 2026", "03:00", "GMT+0", "Primeira fase", "Grupo J", getEstadioPorNome("Estádio de Kansas City").getNome(), getEstadioPorNome("Estádio de Kansas City").getCapacidade(), "Kansas City", "Argélia", "ALG", "Argelina", "Áustria", "AUT", "Austríaca"));
        controller.adicionarJogo(new Jogo("Domingo 28 Junho 2026", "03:00", "GMT+0", "Primeira fase", "Grupo J", getEstadioPorNome("Estádio de Dallas").getNome(), getEstadioPorNome("Estádio de Dallas").getCapacidade(), "Dallas", "Jordânia", "JOR", "Jordana", "Argentina", "ARG", "Argentina"));
        controller.adicionarJogo(new Jogo("Domingo 28 Junho 2026", "20:00", "GMT+0", "Segundas de final", "Dezasseis-avos", getEstadioPorNome("Estádio de Los Angeles").getNome(), getEstadioPorNome("Estádio de Los Angeles").getCapacidade(), "Los Angeles", "2A", "2A", "Apurada", "2B", "2B", "Apurada"));
        controller.adicionarJogo(new Jogo("Segunda-Feira 29 Junho 2026", "18:00", "GMT+0", "Segundas de final", "Dezasseis-avos", getEstadioPorNome("Estádio de Houston").getNome(), getEstadioPorNome("Estádio de Houston").getCapacidade(), "Houston", "1C", "1C", "Apurada", "2F", "2F", "Apurada"));
        controller.adicionarJogo(new Jogo("Segunda-Feira 29 Junho 2026", "21:30", "GMT+0", "Segundas de final", "Dezasseis-avos", getEstadioPorNome("Estádio de Boston").getNome(), getEstadioPorNome("Estádio de Boston").getCapacidade(), "Boston", "1E", "1E", "Apurada", "3ABCDF", "3AB", "Apurada"));
        controller.adicionarJogo(new Jogo("Terça-Feira 30 Junho 2026", "02:00", "GMT+0", "Segundas de final", "Dezasseis-avos", getEstadioPorNome("Estádio de Monterrey").getNome(), getEstadioPorNome("Estádio de Monterrey").getCapacidade(), "Monterrey", "1F", "1F", "Apurada", "2C", "2C", "Apurada"));
        controller.adicionarJogo(new Jogo("Terça-Feira 30 Junho 2026", "18:00", "GMT+0", "Segundas de final", "Dezasseis-avos", getEstadioPorNome("Estádio de Dallas").getNome(), getEstadioPorNome("Estádio de Dallas").getCapacidade(), "Dallas", "2E", "2E", "Apurada", "2I", "2I", "Apurada"));
        controller.adicionarJogo(new Jogo("Terça-Feira 30 Junho 2026", "22:00", "GMT+0", "Segundas de final", "Dezasseis-avos", getEstadioPorNome("Estádio de Nova York/Nova Jersey").getNome(), getEstadioPorNome("Estádio de Nova York/Nova Jersey").getCapacidade(), "Nova Jersey", "1I", "1I", "Apurada", "3CDFGH", "3CD", "Apurada"));
        controller.adicionarJogo(new Jogo("Quarta-Feira 01 Julho 2026", "02:00", "GMT+0", "Segundas de final", "Dezasseis-avos", getEstadioPorNome("Estádio da Cidade do México").getNome(), getEstadioPorNome("Estádio da Cidade do México").getCapacidade(), "Cidade do México", "1A", "1A", "Apurada", "3CEFHI", "3CE", "Apurada"));
        controller.adicionarJogo(new Jogo("Quarta-Feira 01 Julho 2026", "17:00", "GMT+0", "Segundas de final", "Dezasseis-avos", getEstadioPorNome("Estádio de Atlanta").getNome(), getEstadioPorNome("Estádio de Atlanta").getCapacidade(), "Atlanta", "1L", "1L", "Apurada", "3EHIJK", "3EH", "Apurada"));
        controller.adicionarJogo(new Jogo("Quarta-Feira 01 Julho 2026", "21:00", "GMT+0", "Segundas de final", "Dezasseis-avos", getEstadioPorNome("Estádio de Seattle").getNome(), getEstadioPorNome("Estádio de Seattle").getCapacidade(), "Seattle", "1G", "1G", "Apurada", "3AEHIJ", "3AE", "Apurada"));
        controller.adicionarJogo(new Jogo("Quinta-Feira 02 Julho 2026", "01:00", "GMT+0", "Segundas de final", "Dezasseis-avos", getEstadioPorNome("Estádio da Baía de São Francisco").getNome(), getEstadioPorNome("Estádio da Baía de São Francisco").getCapacidade(), "Área da baía de São Francisco", "1D", "1D", "Apurada", "3BEFIJ", "3BE", "Apurada"));
        controller.adicionarJogo(new Jogo("Quinta-Feira 02 Julho 2026", "20:00", "GMT+0", "Segundas de final", "Dezasseis-avos", getEstadioPorNome("Estádio de Los Angeles").getNome(), getEstadioPorNome("Estádio de Los Angeles").getCapacidade(), "Los Angeles", "1H", "1H", "Apurada", "2J", "2J", "Apurada"));
        controller.adicionarJogo(new Jogo("Sexta-Feira 03 Julho 2026", "00:00", "GMT+0", "Segundas de final", "Dezasseis-avos", getEstadioPorNome("Estádio de Toronto").getNome(), getEstadioPorNome("Estádio de Toronto").getCapacidade(), "Toronto", "2K", "2K", "Apurada", "2L", "2L", "Apurada"));
        controller.adicionarJogo(new Jogo("Sexta-Feira 03 Julho 2026", "04:00", "GMT+0", "Segundas de final", "Dezasseis-avos", getEstadioPorNome("BC Place de Vancouver").getNome(), getEstadioPorNome("BC Place de Vancouver").getCapacidade(), "Vancouver", "1B", "1B", "Apurada", "3EFGIJ", "3EF", "Apurada"));
        controller.adicionarJogo(new Jogo("Sexta-Feira 03 Julho 2026", "19:00", "GMT+0", "Segundas de final", "Dezasseis-avos", getEstadioPorNome("Estádio de Dallas").getNome(), getEstadioPorNome("Estádio de Dallas").getCapacidade(), "Dallas", "2D", "2D", "Apurada", "2G", "2G", "Apurada"));
        controller.adicionarJogo(new Jogo("Sexta-Feira 03 Julho 2026", "23:00", "GMT+0", "Segundas de final", "Dezasseis-avos", getEstadioPorNome("Estádio de Miami").getNome(), getEstadioPorNome("Estádio de Miami").getCapacidade(), "Miami", "1J", "1J", "Apurada", "2H", "2H", "Apurada"));
        controller.adicionarJogo(new Jogo("Sábado 04 Julho 2026", "02:30", "GMT+0", "Segundas de final", "Dezasseis-avos", getEstadioPorNome("Estádio de Kansas City").getNome(), getEstadioPorNome("Estádio de Kansas City").getCapacidade(), "Kansas City", "1K", "1K", "Apurada", "3DEIJL", "3DE", "Apurada"));
        controller.adicionarJogo(new Jogo("Sábado 04 Julho 2026", "18:00", "GMT+0", "Oitavas de final", "Oitavos", getEstadioPorNome("Estádio de Houston").getNome(), getEstadioPorNome("Estádio de Houston").getCapacidade(), "Houston", "W73", "W73", "Vencedor", "W75", "W75", "Vencedor"));
        controller.adicionarJogo(new Jogo("Sábado 04 Julho 2026", "22:00", "GMT+0", "Oitavas de final", "Oitavos", getEstadioPorNome("Estádio de Filadélfia").getNome(), getEstadioPorNome("Estádio de Filadélfia").getCapacidade(), "Filadélfia", "W74", "W74", "Vencedor", "W77", "W77", "Vencedor"));
        controller.adicionarJogo(new Jogo("Domingo 05 Julho 2026", "21:00", "GMT+0", "Oitavas de final", "Oitavos", getEstadioPorNome("Estádio de Nova York/Nova Jersey").getNome(), getEstadioPorNome("Estádio de Nova York/Nova Jersey").getCapacidade(), "Nova Jersey", "W76", "W76", "Vencedor", "W78", "W78", "Vencedor"));
        controller.adicionarJogo(new Jogo("Segunda-Feira 06 Julho 2026", "01:00", "GMT+0", "Oitavas de final", "Oitavos", getEstadioPorNome("Estádio da Cidade do México").getNome(), getEstadioPorNome("Estádio da Cidade do México").getCapacidade(), "Cidade do México", "W79", "W79", "Vencedor", "W80", "W80", "Vencedor"));
        controller.adicionarJogo(new Jogo("Segunda-Feira 06 Julho 2026", "20:00", "GMT+0", "Oitavas de final", "Oitavos", getEstadioPorNome("Estádio de Dallas").getNome(), getEstadioPorNome("Estádio de Dallas").getCapacidade(), "Dallas", "W83", "W83", "Vencedor", "W84", "W84", "Vencedor"));
        controller.adicionarJogo(new Jogo("Terça-Feira 07 Julho 2026", "01:00", "GMT+0", "Oitavas de final", "Oitavos", getEstadioPorNome("Estádio de Seattle").getNome(), getEstadioPorNome("Estádio de Seattle").getCapacidade(), "Seattle", "W81", "W81", "Vencedor", "W82", "W82", "Vencedor"));
        controller.adicionarJogo(new Jogo("Terça-Feira 07 Julho 2026", "17:00", "GMT+0", "Oitavas de final", "Oitavos", getEstadioPorNome("Estádio de Atlanta").getNome(), getEstadioPorNome("Estádio de Atlanta").getCapacidade(), "Atlanta", "W86", "W86", "Vencedor", "W88", "W88", "Vencedor"));
        controller.adicionarJogo(new Jogo("Terça-Feira 07 Julho 2026", "21:00", "GMT+0", "Oitavas de final", "Oitavos", getEstadioPorNome("BC Place de Vancouver").getNome(), getEstadioPorNome("BC Place de Vancouver").getCapacidade(), "Vancouver", "W85", "W85", "Vencedor", "W87", "W87", "Vencedor"));
        controller.adicionarJogo(new Jogo("Quinta-Feira 09 Julho 2026", "21:00", "GMT+0", "Quartas de final", "Quartos", getEstadioPorNome("Estádio de Boston").getNome(), getEstadioPorNome("Estádio de Boston").getCapacidade(), "Boston", "W89", "W89", "Vencedor", "W90", "W90", "Vencedor"));
        controller.adicionarJogo(new Jogo("Sexta-Feira 10 Julho 2026", "20:00", "GMT+0", "Quartas de final", "Quartos", getEstadioPorNome("Estádio de Los Angeles").getNome(), getEstadioPorNome("Estádio de Los Angeles").getCapacidade(), "Los Angeles", "W93", "W93", "Vencedor", "W94", "W94", "Vencedor"));
        controller.adicionarJogo(new Jogo("Sábado 11 Julho 2026", "22:00", "GMT+0", "Quartas de final", "Quartos", getEstadioPorNome("Estádio de Miami").getNome(), getEstadioPorNome("Estádio de Miami").getCapacidade(), "Miami", "W91", "W91", "Vencedor", "W92", "W92", "Vencedor"));
        controller.adicionarJogo(new Jogo("Domingo 12 Julho 2026", "02:00", "GMT+0", "Quartas de final", "Quartos", getEstadioPorNome("Estádio de Kansas City").getNome(), getEstadioPorNome("Estádio de Kansas City").getCapacidade(), "Kansas City", "W95", "W95", "Vencedor", "W96", "W96", "Vencedor"));
        controller.adicionarJogo(new Jogo("Terça-Feira 14 Julho 2026", "20:00", "GMT+0", "Semifinal", "Semi", getEstadioPorNome("Estádio de Dallas").getNome(), getEstadioPorNome("Estádio de Dallas").getCapacidade(), "Dallas", "W97", "W97", "Vencedor", "W98", "W98", "Vencedor"));
        controller.adicionarJogo(new Jogo("Quarta-Feira 15 Julho 2026", "20:00", "GMT+0", "Semifinal", "Semi", getEstadioPorNome("Estádio de Atlanta").getNome(), getEstadioPorNome("Estádio de Atlanta").getCapacidade(), "Atlanta", "W99", "W99", "Vencedor", "W100", "W100", "Vencedor"));
        controller.adicionarJogo(new Jogo("Sábado 18 Julho 2026", "22:00", "GMT+0", "Decisão do 3º lugar", "3º Lugar", getEstadioPorNome("Estádio de Miami").getNome(), getEstadioPorNome("Estádio de Miami").getCapacidade(), "Miami", "RU101", "RU1", "Derrotado", "RU102", "RU2", "Derrotado"));
        controller.adicionarJogo(new Jogo("Domingo 19 Julho 2026", "20:00", "GMT+0", "Final", "Finalíssima", getEstadioPorNome("Estádio de Nova York/Nova Jersey").getNome(), getEstadioPorNome("Estádio de Nova York/Nova Jersey").getCapacidade(), "Nova Jersey", "W101", "W101", "Campeão", "W102", "W102", "Campeão"));
    }
